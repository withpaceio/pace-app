...
import type { ConfigureHealthInformationScreenProps, SettingsScreenProps } from '@navigation/types';
...
const ConfigureHealthInformationScreen: FC<ConfigureHealthInformationScreenProps> = () => {
  const {
